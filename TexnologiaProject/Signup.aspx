        ...
        <div class="row">
            <div class="col-md-6" style="text-align: center">
                <div class="row" style="margin-top: 70px;">
                    <h3 style="font-family:Times New Roman; color:#6b6a6a; width:170px; height: 30px;" >Signup!</h3>
                    ...
                    <asp:Label ID="LblRePassword" runat="server" Text="Re-enter password"></asp:Label><br />
                    <asp:TextBox ID="CheckRePassword" TextMode="Password" runat="server"></asp:TextBox><br />
                    <asp:Label ID="Label1" runat="server" Text="Date of Birth"></asp:Label><br />
